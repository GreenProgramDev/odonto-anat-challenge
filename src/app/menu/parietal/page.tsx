...
export default function ParietalGroup(){
    ...
    return(
        ...
        <div className='grid grid-cols-3  gap-x-3 gap-y-2 py-1 '>                            
            ...
            <QuizLink src={PagA2} href="/menu/parietal/structure01">Option 01</QuizLink>
            <QuizLink src={PagB2} href="/menu/parietal/structure02">Option 02</QuizLink>
            <QuizLink src={PagC2} href="/menu/parietal/structure03">Option 03</QuizLink>
        </div>   
        </div>
        </>
