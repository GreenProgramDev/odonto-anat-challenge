...
import PageOne from '../../../../../../public/assets/imgBoneSkull/pageB1.svg';
...
export default function Quiz2() {
   ...
   ?   <Link className=" text-sm" href="/menu/skull/boneSkull/quiz3">Next Quiz</Link> 
   : "Next"
    ...
    return (
        <>
                ...
                <div className='fixed bottom-5 flex gap-16 pt-10'>
                    <ButtonBack/>
                    <Link className='text-cyan-50 border-b-2 rounded-md px-3 ' href="/menu/skull">Menu</Link>
                    <Link className="text-cyan-50 border-r-2 border-b-2 rounded-md px-3 font-bold" href="/menu/skull/boneSkull/quiz3">Next</Link>
                </div>
                </div>
        </>
    )
