...
import PageOne from '../../../../../../public/assets/imgTemporal/pageA1.png';
...
export default function Quiz1() {
   ...
   ?   <Link className=" text-sm" href="/menu/skull/temporal/quiz2">Next Quiz</Link> 
   : "Next"
    ...
    return (
        <>
                ...
                <div className='fixed bottom-5 flex gap-16 pt-10'>
                    <Link className='text-cyan-50 border-l-2 border-b-2 rounded-md px-3 ' href="/menu/skull">Menu</Link>
                    <Link className="text-cyan-50 border-r-2 border-b-2 rounded-md px-3 font-bold" href="/menu/skull/temporal/quiz2">Next</Link>
                </div>
                </div>
        </>
    )
