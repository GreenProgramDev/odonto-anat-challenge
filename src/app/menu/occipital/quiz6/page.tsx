...
import PageOne from '../../../../../public/assets/pageF1.svg';
...
export default function Quiz6() { 
    ...
    let structure = [
        ...
        generateQuestions(namesBones, "Canal óptico"),
        generateQuestions(namesBones, "Jugo esfenoidal"),
        ...
        generateQuestions(namesBones, "Proc. clinóide anterior"),
        generateQuestions(namesBones, "Proc. clinóide posterior"),
        generateQuestions(namesBones, "Fossa hipofisial"),
        generateQuestions(namesBones, "Sela turca"),
