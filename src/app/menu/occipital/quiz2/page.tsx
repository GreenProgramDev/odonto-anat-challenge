...
export default function Quiz2() {
    ...
    let structure = [
        ...
        generateQuestions(namesBones, "Tubérculo articular"),
        ...
        generateQuestions(namesBones, "Incisura mastóidea"),
        generateQuestions(namesBones, "Forame mastóideo"),
        generateQuestions(namesBones, "Forame estilomastóideo"),
        generateQuestions(namesBones, "Fossa jugular"),
        generateQuestions(namesBones, "Proc. estilóide"),
        generateQuestions(namesBones, "Canal carótico"),
   ...
   ?   <Link className="" href="/menu/occipital/quiz3">Next Quiz</Link> 
   : "Next"
