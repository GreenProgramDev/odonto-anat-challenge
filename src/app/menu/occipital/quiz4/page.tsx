...
export default function Quiz4() {
   ...
   ?   <Link className=" text-sm" href="/menu/occipital/quiz5">Next Quiz</Link> 
   : "Next"
    ...
    return (
        <>
                ...
                <div className='fixed bottom-5 flex gap-16 pt-10'>
                    ...
                    <Link className="text-cyan-50 border-r-2 border-b-2 rounded-md px-3 font-bold" href="/menu/occipital/quiz5">Next</Link>
                </div>
                </div>
        </>
    )
